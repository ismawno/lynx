...
namespace lynx
{
vertex2D::vertex2D(const glm::vec2 &pposition, const lynx::color &pcolor) : position(pposition), color(pcolor)
{
}
...
vertex3D::vertex3D(const glm::vec3 &pposition, const lynx::color &pcolor) : position(pposition), color(pcolor)
{
}
